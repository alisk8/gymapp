...
//         if (
//           lastVisible[userId] &&
//           lastVisible[userId].highlight &&
//           !isRefresh
//         ) {
//           highlightsQuery = query(
//             highlightsQuery,
//             startAfter(lastVisible[userId].highlight)
//           );
//         }
//         if (lastVisible[userId] && lastVisible[userId].workout && !isRefresh) {
//           workoutsQuery = query(
//             workoutsQuery,
//             startAfter(lastVisible[userId].workout)
//           );
//         }
...
//                 profilePicture:
//                   userProfileData.profilePicture || defaultProfilePicture,
//                 timestamp: highlightData.timestamp
//                   ? highlightData.timestamp.toDate()
//                   : null,
//                 liked: highlightData.likes
//                   ? highlightData.likes.includes(currentUserUid)
//                   : false,
//                 saved: highlightData.savedBy
//                   ? highlightData.savedBy.includes(currentUserUid)
//                   : false,
//                 likes: highlightData.likes ? highlightData.likes.length : 0,
//                 savedBy: highlightData.savedBy
//                   ? highlightData.savedBy.length
//                   : 0,
//                 commentCount,
//               });
...
//                 profilePicture:
//                   userProfileData.profilePicture || defaultProfilePicture,
//                 timestamp: workoutData.createdAt
//                   ? workoutData.createdAt.toDate()
//                   : null,
//                 liked: workoutData.likes
//                   ? workoutData.likes.includes(currentUserUid)
//                   : false,
//                 saved: workoutData.savedBy
//                   ? workoutData.savedBy.includes(currentUserUid)
//                   : false,
...
//           );
//           return [...prevHighlights, ...filteredNewHighlights].sort(
...
//           prevHighlights.map((post) =>
//             post.id === postId
//               ? { ...post, saved: true, savedBy: post.savedBy + 1 }
//               : post
//           )
//         );
//       } else {
...
const FeedPage = ({ navigation }) => {
  ...
  const fetchHighlights = async (isRefresh = false) => {
    ...
    try {
      ...
      setHighlights(isRefresh ? sortedData : [...highlights, ...sortedData]);
      setLastVisible(newLastVisible);
      setLoading(false);
      setRefreshing(false);
    } catch (error) {
